...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('duration_type', models.PositiveSmallIntegerField(choices=[(30, 'One month'), (183, 'Six month'), (365, 'One year')], default=30, help_text='Card duration type', verbose_name='card_duration_type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_time', models.DateTimeField(default=django.utils.timezone.now, help_text='Transaction date and time', verbose_name='date_time')),

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('card_duration_type', models.DurationField(choices=[(datetime.timedelta(days=30), 'One month'), (datetime.timedelta(days=183), 'Six month'), (datetime.timedelta(days=365), 'One year')], default=datetime.timedelta(days=30), help_text='Card duration type', verbose_name='card_duration_type')),
                ...
                ('status', models.PositiveSmallIntegerField(choices=[(0, 'Not activated'), (1, 'Active'), (2, 'Outdated')], default=0, help_text='Card status', verbose_name='status')),
            ],
            options={
                'verbose_name': 'card',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(check=models.Q(('amount', Decimal('0')), _negated=True), name='zero_amount_transaction'),
        ),
        migrations.AddConstraint(
            model_name='card',
            constraint=models.CheckConstraint(check=models.Q(('balance__gte', Decimal('0'))), name='balance_is_not_negative'),
        ),
        migrations.AddConstraint(
            model_name='card',
            constraint=models.UniqueConstraint(fields=('series', 'number'), name='series_number_unique_constraint'),
        ),
    ]
